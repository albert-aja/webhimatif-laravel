...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="/Admin/KontakUM" class="btn btn-icon">
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <form method="post">
                    <?= csrf_field() ;?>
                    <div class="card-body">
                        <input type="hidden" name="id" value="<?= $kontakUM['id'] ?>">
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                placeholder="Media Sosial" value="<?= (old('social')) ?? $kontakUM['social'] ;?>" autofocus>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-10 col-md-6">
                                ...
                                placeholder="Link Media Sosial (https://example.com)" value="<?= (old('link')) ?? $kontakUM['link'] ;?>">
                                <div class="invalid-feedback">
                                    <?= $validation->getError('link') ;?>
                                </div>
                            </div>
                            <div class="col-sm-2 col-md-2">
                                <a href="<?= (old('link')) ?? $kontakUM['link'];?>" class="btn btn-secondary" id="linkTo"
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <div class="input-group colorpickerinput">
                                    ...
                                    name="hex" placeholder="Hex Code" value="<?= (old('hex')) ?? $kontakUM['color'] ;?>">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7 social-links">
                                ...
                                style="background: <?= (old('hex')) ?? $kontakUM['color'] ?> ">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7 float-end">
                                <button class="btn btn-primary" type="submit" formaction="/admin/KontakUM/edit_kontakUM">Tambah</button>
                                <a class="btn btn-info" href="/admin/KontakUM">Kembali</a>
                            </div>
                        </div>
                    </div>
                </form>
