    ...
    @csrf
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <input type="text" name="item" class="form-control" value="{{ $item->item }}" placeholder="@lang('admin/crud.variable.item')" id="item">
            ...
            <div class="form-group">
                ...
                <div id="photo">
                    <div class="input-images" data-folder="{{ asset($img_path) }}" data-images="{{ $photos }}"></div>
                </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="ckeditor" class="form-control">{!! $item->description !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2" name="product__categories_id" id="category">
                    ...
                    <option value="{{ $category->id }}" @if($category->id == $item->product__categories_id) selected @endif>
                        {{ $category->category }}
                    </option>
                    @endforeach
                </select>
                ...
                @foreach ($colors as $color)
                    <div class="col-auto">
                        <label class="colorinput">
                            <input name="color[]" type="checkbox" value="{{ $color->id }}" class="colorinput-input" @if($product_colors->contains($color->id)) checked @endif/>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" name="fromPrice" class="form-control" placeholder="@lang('admin/crud.form.fromPrice')" id="fromPrice" value="{{ $price[0] }}">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="toPrice" class="form-control" placeholder="@lang('admin/crud.form.toPrice')" id="toPrice" value="{{ $price[1] ?? '' }}">
