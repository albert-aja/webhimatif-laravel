                    ...
                    <div class="card-body">
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                placeholder="Warna" value="<?= old('warna') ;?>" autofocus>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <div class="input-group colorpickerinput">
                                    ...
                                    id="hex-input" value="<?= old('hex') ;?>" maxlength="7" pattern="^#(?:[0-9a-fA-F]{3}){1,2}$">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7 float-end">
                                <button class="btn btn-primary clicked-button" type="submit" formaction="/admin/shop/add_warna">Tambah</button>
