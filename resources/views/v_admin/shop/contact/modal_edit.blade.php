<x-modal modalID="modal_edit_contact" modalSize="" :title="__('admin/crud.form.edit', $page)">
    <form method="post" id="form_edit_contact">
    @method('PUT')
    @csrf
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <input type="text" name="social" class="form-control" placeholder="@lang('admin/crud.variable.social_media')" id="social_media" value="{{ $contact->social }}">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-9">
                        <input type="text" name="link" class="form-control linkMediaSosial" placeholder="@lang('admin/crud.variable.link')" id="link" value="{{ $contact->link }}">
                ...
                <div class="selectgroup selectgroup-pills" id="selecticons">
                    <div>
                        ...
                        <label class="selectgroup-item">
                            <input type="radio" name="icon" value="{{ $icon['icon'] }}" class="selectgroup-input form-control" {{ ($contact->icon == $icon['icon']) ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <div class="input-group colorpickerinput">
                    <input type="text" name="color" class="form-control" placeholder="@lang('admin/crud.variable.hex')" id="hex_code" maxlength="7"  value="{{ $contact->color }}">
