                ...
                <div class="card-body">
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <textarea oninput="auto_grow(this)" class="single-textarea <?= ($validation->hasError('misi')) ? 'is-invalid' : '' ;?>" name="misi" autofocus><?= ($validation->hasError('misi')) ? old('misi') : $misi['isi'] ;?></textarea>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7 float-end">
                            <button class="btn btn-primary clicked-button" type="submit" formaction="/admin/config/edit_misi?id=<?= $misi['id'] ;?>">Edit</button>
