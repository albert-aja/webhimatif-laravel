                    ...
                    <div class="card-body">
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="nama" id="nama" placeholder="Nama Divisi" autofocus 
                                class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : '' ;?>" 
                                value="<?= (old('name')) ?? $divisi['divisi'] ?>">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="alias" id="alias" placeholder="Contoh: BPH, Mulkom, Litbang" 
                                class="form-control <?= ($validation->hasError('alias')) ? 'is-invalid' : '' ;?>" 
                                value="<?= (old('alias')) ?? $divisi['alias'] ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7 float-end">
                                <button class="btn btn-primary clicked-button" type="submit" formaction="/admin/divisi/edit_divisi?id=<?= $divisi['id'] ;?>&slug=<?= $divisi['slug'] ;?>">Edit</button>
