                    ...
                    <div class="card-body">
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                placeholder="Nama Produk" value="<?= old('item') ;?>" autofocus>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                placeholder="Harga (contoh: 10000)" value="<?= old('harga') ;?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7 float-end">
                                <button class="btn btn-primary clicked-button" type="submit" formaction="/admin/shop/add_item">Tambah</button>
